...
import { dismissUpgradeModal } from "../../redux/actions/AuthActions";

export function UpgradeAccountModal() {
  const dispatch = useDispatch();
  const { t } = useTranslation();
  const { showUpgradeModal = false } = useSelector(
    (state) => state.auth,
    shallowEqual
  );
